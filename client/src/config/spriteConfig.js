...
// Re-export the pure palette so existing importers of spriteConfig keep working
// (the canonical data now lives in colorPresets.js so the Node bake can share it).
export {
  COLOR_PRESETS,
  BODY_COLOR_PRESETS,
  SPRITE_BASE_COLOR,
