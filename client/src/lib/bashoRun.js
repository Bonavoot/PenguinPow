...
const RIKISHI = {
  lower: [
    { name: "Waddlemaru", archetype: "pusher", mawashiColor: "#DA1B44", bodyColor: null },
    { name: "Sir Slipsalot", archetype: "counter", mawashiColor: "#1BBADA", bodyColor: null },
    { name: "Brrrtholomew", archetype: "grappler", mawashiColor: "#15AC7D", bodyColor: "#4A4A4A" },
    { name: "Wobbleyama", archetype: "balanced", mawashiColor: "#E98520", bodyColor: null },
    { name: "Krillbasher", archetype: "brawler", mawashiColor: "#9E1A3F", bodyColor: null },
    { name: "Tubby Tachiai", archetype: "grappler", mawashiColor: "#A22EE5", bodyColor: "#2656A8" },
    { name: "Slushpuppy", archetype: "balanced", mawashiColor: "#F0E4C4", bodyColor: null },
    { name: "Flipper McShove", archetype: "pusher", mawashiColor: "#E6BD37", bodyColor: null },
    { name: "Captain Coldcuts", archetype: "counter", mawashiColor: "#4F4F4F", bodyColor: null },
    { name: "Señor Belly", archetype: "grappler", mawashiColor: "#E52E8A", bodyColor: "#8B5E3C" },
    { name: "Frostbite Fumio", archetype: "pusher", mawashiColor: "#15AC7D", bodyColor: null },
    { name: "Beaky Blinders", archetype: "brawler", mawashiColor: "#A22EE5", bodyColor: null },
  ],
  mid: [
    { name: "Mackerelyama", archetype: "grappler", mawashiColor: "#1BBADA", bodyColor: "#2656A8" },
    { name: "Sushi Sumoto", archetype: "pusher", mawashiColor: "#DA1B44", bodyColor: null },
    { name: "Iceberg Ichiro", archetype: "counter", mawashiColor: "#F0E4C4", bodyColor: null },
    { name: "Blubbernishiki", archetype: "grappler", mawashiColor: "#A22EE5", bodyColor: "#4A4A4A" },
    { name: "Glacier Gunkan", archetype: "pusher", mawashiColor: "#4F4F4F", bodyColor: null },
    { name: "Chill Norris", archetype: "counter", mawashiColor: "#15AC7D", bodyColor: null },
    { name: "Penguinzilla", archetype: "brawler", mawashiColor: "#9E1A3F", bodyColor: "#8B5E3C" },
  ],
  elite: [
    { name: "Hakupengu", archetype: "counter", mawashiColor: "#E6BD37", bodyColor: null },
    { name: "Shōgun Shirayuki", archetype: "pusher", mawashiColor: "#F0E4C4", bodyColor: null },
    { name: "The Tuxedo Tempest", archetype: "brawler", mawashiColor: "#4F4F4F", bodyColor: null },
    { name: "Avalanche Akira", archetype: "grappler", mawashiColor: "#1BBADA", bodyColor: "#4A4A4A" },
    { name: "Daimyo Defrost", archetype: "counter", mawashiColor: "#A22EE5", bodyColor: null },
    { name: "Chonkaisho", archetype: "grappler", mawashiColor: "#E98520", bodyColor: "#8B5E3C" },
    { name: "Yoko-ZONO", archetype: "brawler", mawashiColor: "#E52E8A", bodyColor: null },
  ],
};
