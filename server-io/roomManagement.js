...
function resetRoomAndPlayers(room, io) {
  ...
  room.players.forEach((player) => {
    ...
    player.offensiveAerialPresentation = null;
    player._oaTouchdownPresentation = false;
    player._oaGroundedStagger = false;
    player._oaFacingPreviousValid = null;
    player._oaFacingLastRelease = null;
    player._oaFacingStaleRejects = 0;
    ...
    player._actionFacingSeq = 0;
    player._afFacingPreviousValid = null;
    ...
    player._combatContactActionSeq = 0;
    ...
    player._offensiveAerialReactionRejects = 0;
