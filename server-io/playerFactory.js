...
function createInitialPlayerState(overrides = {}) {
  const base = {
    ...
    _actionFacingSeq: 0,
    _afFacingPreviousValid: null,
    _afFacingLastRelease: null,
    _afFacingLastReject: null,
    _afFacingStaleRejects: 0,
    // Phase 15 — action lifecycle ownership (default ON; approved)
    lifecycleOwners: null,
    slapLifecycleInstanceId: null,
    chargedLifecycleInstanceId: null,
    chargedEndlagInstanceId: null,
    hitstunLifecycleInstanceId: null,
    parryStaggerLifecycleInstanceId: null,
    dodgeLifecycleInstanceId: null,
    _lifecycleSeq: 0,
    _lifecycleStaleRejects: 0,
    _lifecycleLastTransition: null,
    _lifecycleLastCompletion: null,
    _lifecycleLastControlRestore: null,
    _lifecycleLastReject: null,
    _combatContactConsumed: false,
    _combatContactConsumedAt: 0,
    _combatContactActionInstanceId: null,
    _combatContactActionSeq: 0,
    _combatContactActivePoseSurvivalTicks: 0,
    slapActiveEndTime: 0,
    ...
    dirATapTime: 0,
    dirDTapTime: 0,
    _strikeFacingSnap: null,
    _pendingPalmChordUntil: 0,
    _lastInputCommandReject: null,
    _lastInputCommandRejectAt: 0,
    _lastInputCommandAccept: null,
